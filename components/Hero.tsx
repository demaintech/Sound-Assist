    ...
    <main className="w-full h-screen  flex lg:flex-row flex-col justify-between items-center lg:px-24 pt-12 lg:pt-0">
      ...
      <div className="lg:w-[45%] w-full -mt-3">
        ...
        <motion.div
          ...
          className="flex flex-col justify-center lg:justify-start items-center lg:items-start gap-3 pt-20 lg:pt-0"
        >
          <h1 className="lg:text-[80px] text-[35px] leading-tight font-extrabold text-center lg:text-start">
            Welcome to <br />{" "}
            <span className="text-[#032d77]">Sound Assist</span>
          </h1>
          <p className="lg:text-[18px] text-[15px] font-medium text-gray-600 lg:w-[90%] w-[90%] mt-4 text-center lg:text-left mx-auto lg:mx-0 ">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quia
            praesentium doloribus deserunt, a corrupti culpa, deleniti id ad
            necessitatibus quidem iusto aut eius pariatur quisquam labore est
            aliquid maxime vitae!
          </p>
        </motion.div>
        ...
        >
          <button className="lg:w-[250px] w-[150px] lg:h-[55px] h-[46px] bg-[#012057] hover:bg-[#3762ad] cursor-pointer transition-opacity  lg:text-[20px] text-[14px] text-white rounded-[50px] font-semibold ">
            Seek Assistance
          </button>
